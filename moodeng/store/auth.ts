...
const endpoint = `${process.env.NEXT_PUBLIC_BACKEND_ENDPOINT}:4006/api/v1/db/partner/login`//   `${"http://localhost"}:4006/api/v1/db/login`//`${process.env.NEXT_PUBLIC_BACKEND_ENDPOINT}:4006/api/v1/db/login`// process.env.NEXT_PUBLIC_BACKEND_ENDPOINT +"api/v1/users/login"
